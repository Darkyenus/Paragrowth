...
void main() {
	...
	vec3 b_position = mix(a_position, a_position_blend, blend);
	vec4 b_color = mix(a_color, a_color_blend, blend);
	vec4 b_normal = normalize(mix(a_normal, a_normal_blend, blend));
